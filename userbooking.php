						...
						<div class="col-md-12 col-sm-12">
							<div class="tj-tabs">
								<ul class="nav nav-tabs" role="tablist">
									<li class="active" ><a href="userbooking.php" ><i class="far fa fa-user"></i> Active Booking</a></li>
            ...
            <div class="events-agileits-w3layouts">
	            	<div class="container">
                            ...
                            <?php
                                ...
                                $query ="SELECT packages.package_id,packages.pname,packages.pimg,packages.hprice,packages.dprice,packages.pdescription,packages.tprice,book.starttime,book.date,book.people,book.book_id,book.bookdate,book.totalamount from book join packages on packages.package_id=book.package_id where book.status='0'  && book.email='$email'";
					...
					<div class="col-md-4 popular-grid">
						...
						<div class="popular-text">
                            ...
                            <ul>
                                     ...
                                     <a href="cancel.php?bid=<?php echo ($row['book_id']);?>">                             
                                        <button type="button" class="btn  btn-danger">                                      
                                        cancel  <i class="fas fa fa-share"></i>
                                        </button> 
                                        </a>
