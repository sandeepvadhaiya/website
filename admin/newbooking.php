      ...
      <div id="content">
        ...
        <div class="container-fluid">
         ...
         <div class="card shadow mb-4">
                    ...
                    <h6 class="m-10 font-weight-bold text-primary">View Newbooking</h6>
                    </div>
                <div class="card-body">
                    ...
                    <form method="post" action="">
                         ...
                         <thead>  
                          ...
                          <?php
                                        ...
                                        $query ="SELECT packages.pname,book.book_id,book.name,book.phoneno,book.email,book.address,book.starttime,book.date,book.people,book.bookdate,book.totalamount from book join packages on packages.package_id=book.package_id where book.status='0'";
                                        ...
                                        foreach($result as $row)
                                        {
                                          ?>
                                            ...
                                            <a href="accept.php?s=1&id=<?php echo $row['book_id']?>">
                                         
                                            <button type='button'   class='btn btn-success'>Accept</button></a> 
                                            
                                               </td> 
                                            <td>
                                            <a href="cancel.php?s=2&id=<?php echo $row['book_id']?>">
