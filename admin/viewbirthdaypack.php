...
?>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"><?php echo ($row['etype']);?></h6>
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      ...
                      <i class="fas fa-fw fa-pencil-square-o"></i>
                       ...
                       <a class="dropdown-item" href="viewbirthdaypack.php?presid=<?php echo ($row['package_id']);?>&&action=perdel" onclick="return confirm('Do you really want to delete ?')">
