      ...
      <div id="content">
        ...
        <div class="container-fluid">
         ...
         <div class="card shadow mb-4">
                    ...
                    <h6 class="m-10 font-weight-bold text-primary">View Approvedbooking</h6>
                    </div>
                <div class="card-body">
                    ...
                    <form method="post" action="">
                         ...
                         <thead>  
                          ...
                          <?php
                                        ...
                                        $query ="SELECT packages.pname,book.name,book.phoneno,book.email,book.address,book.starttime,book.date,book.people,book.bookdate,book.totalamount from book join packages on packages.package_id=book.package_id where book.status='1' ";
