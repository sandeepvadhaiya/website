                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      <tr>
                             ...
                             <input type="hidden" name="aboutus_id" value="<?php echo $row['aboutus_id'] ?>"/>  
                            ...
                            <td>
                                       <input name="save" type="submit" id="save" value="save"  class='btn btn-success' data-toggle='modal' data-target='#exampleModalCenter' al ign="top">   
                            </td>
                          </div>
                    </tr>
