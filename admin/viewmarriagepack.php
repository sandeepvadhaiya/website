...
<body id="page-top">                                  
 ...
 <?php
  ...
  $query ="select * from packages where etype='marriage'";
  $query_run =mysqli_query($connection,$query);
                  ...
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      ...
                      <i class="fas fa-fw fa-pencil-square-o"></i>
                       ...
                       <a class="dropdown-item" href="viewmarriagepack.php?presid=<?php echo ($row['package_id']);?>&&action=perdel" onclick="return confirm('Do you really want to delete ?')"">
