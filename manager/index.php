            ...
            <div class="col-xl-3 col-md-6 mb-4">
              ...
              <a href="manageposts.php">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total News Posts</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
            ...
            <div class="col-xl-3 col-md-6 mb-4">
             ...
             <a href="newbooking.php">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Pending Bookings</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
             ...
             <div class="col-xl-3 col-md-6 mb-4">
               ...
               <a href="cancelledbooking.php">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Cancel Bookings</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
