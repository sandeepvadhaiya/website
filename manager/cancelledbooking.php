                    ...
                    <form method="post" action="">
                         ...
                         <thead>  
                          ...
                          <?php
                                        ...
                                        $query ="SELECT packages.pname,book.name,book.phoneno,book.email,book.address,book.starttime,book.date,book.people,book.bookdate from book join packages on packages.package_id=book.package_id where book.status='2'";
